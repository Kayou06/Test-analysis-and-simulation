This folder contains the CFD simulation for the ORCHID nozzle for a compressibility factor of ~0.65.
...
The file BOS_12_11_2_CFD.dat contains the extracted data at the nozzle midplane from the file flow_MUSCL.vtu.
